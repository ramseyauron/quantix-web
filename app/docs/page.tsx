  ...
  return (
    ...
    >
      ...
      <aside className="hidden lg:flex flex-col w-64 shrink-0 border-r border-cyan-500/10 sticky top-16 h-[calc(100vh-4rem)] overflow-y-auto p-6">
        <div className="mb-6">
          <p className="text-xs uppercase tracking-widest text-cyan-400/60 mb-3">
            Documentation
          </p>
      ...
      <main className="flex-1 max-w-4xl mx-auto px-6 py-12 overflow-y-auto">
        ...
        <div className="mb-12">
          ...
          <p className="text-slate-400 text-lg">
            Complete technical documentation for the post-quantum Layer 1
            blockchain.
          </p>
        </div>
        ...
        <section id="overview" className="mb-16 scroll-mt-20">
          ...
          <div className="prose prose-invert max-w-none space-y-4 text-slate-300 leading-relaxed">
            <p>
              Quantix is an open-source, post-quantum secure blockchain Layer 1
              protocol written in Go. It is designed to provide cryptographic
              security that remains robust against both classical and quantum
              computing threats — including attacks from sufficiently powerful
              quantum computers running Shor&apos;s or Grover&apos;s algorithms.
            </p>
            <p>
              Traditional blockchains rely on ECDSA (Elliptic Curve Digital
              Signature Algorithm) for transaction signing. ECDSA is vulnerable
              to Shor&apos;s algorithm, which a quantum computer could use to
              derive private keys from public keys. Quantix eliminates this
              attack surface by replacing ECDSA with{" "}
              <strong className="text-cyan-400">SPHINCS+</strong>, a stateless
              hash-based signature scheme standardized by NIST as a post-quantum
              standard.
            </p>
            ...
            <ul className="space-y-2">
              <li className="flex gap-3">
                ...
                <span>
                  <strong className="text-white">Privacy</strong> is a
                  fundamental human right, not a luxury — enforced by
              ...
              <li className="flex gap-3">
                <span className="text-cyan-400 mt-0.5">◆</span>
                <span>
                  <strong className="text-white">Sovereignty</strong> means
                  individuals should have complete control over their digital
                  assets and identity.
                </span>
              </li>
              <li className="flex gap-3">
                <span className="text-cyan-400 mt-0.5">◆</span>
                <span>
                  <strong className="text-white">Humanity</strong> must be
                  preserved through technology that serves people, not
        ...
        <section id="architecture" className="mb-16 scroll-mt-20">
          <h2
            ...
            style={{ fontFamily: "var(--font-orbitron)" }}
          >
            <span className="w-8 h-8 rounded-lg bg-purple-500/10 border border-purple-500/20 flex items-center justify-center text-purple-400 text-sm">
              02
            </span>
            Architecture
          </h2>
          <div className="space-y-4 text-slate-300 leading-relaxed">
            <p>
              Quantix is structured as a modular Go codebase with clear
              separation between layers:
            </p>

            <div className="bg-black/40 rounded-xl border border-white/8 overflow-hidden my-6">
              <div className="bg-white/5 px-4 py-2 text-xs text-slate-400 border-b border-white/5">
                Architecture Stack
              </div>
              <div className="p-4 font-mono text-sm space-y-1">
                {[
                  [
                    "Application Layer",
                    "CLI, HTTP API, WebSocket, RPC",
                    "#00FFFF",
                  ],
                  ["Consensus Layer", "PBFT + PoS + RANDAO/VDF", "#7B61FF"],
                  [
                    "Execution Layer",
                    "SVM (Sphinx VM), State Execution",
                    "#FF00FF",
                  ],
                  [
                    "State Layer",
                    "Account balances, Nonces, State root",
                    "#00FFFF",
                  ],
                  ["Transaction Layer", "Mempool, Validation, UTXO", "#7B61FF"],
                  [
                    "Cryptography Layer",
                    "SPHINCS+, Kyber768, SWIFFTX, STARK",
                    "#FF00FF",
                  ],
                  ...
                  <div key={name} className="flex gap-4 items-baseline">
                    <span className="w-44 shrink-0 text-xs" style={{ color }}>
                      {name}
                    </span>
            ...
            <div className="space-y-3">
              {[
                {
                  path: "src/consensus/",
                  desc: "PBFT engine, RANDAO beacon, VDF computation, validator set management, slashing",
                },
                {
                  path: "src/core/",
                  desc: "Blockchain state, block execution, genesis, transaction types, wallet, SVM opcodes",
                },
                {
                  path: "src/crypto/",
                  desc: "SPHINCS+ implementation, SWIFFTX hash, STARK proofs, WOTS+ signatures",
                },
                {
                  path: "src/handshake/",
                  desc: "X25519 + Kyber768 hybrid key exchange for node-to-node encryption",
                },
                {
                  path: "src/p2p/",
                  desc: "Peer discovery, connection management, message routing",
                },
                {
                  path: "src/dht/",
                  desc: "Distributed Hash Table for peer discovery using 32-byte crypto secrets",
                },
                {
                  path: "src/pool/",
                  desc: "Mempool with nonce replay protection, balance checks, gas enforcement",
                },
                {
                  path: "src/state/",
                  desc: "Storage abstraction, account state, LevelDB interface",
                },
              ].map(({ path, desc }) => (
                <div
                  key={path}
                  className="flex gap-4 p-3 bg-white/3 rounded-lg border border-white/5"
                >
                  <code className="text-cyan-400 text-xs font-mono shrink-0 w-36">
                    {path}
                  </code>
        ...
        <section id="consensus" className="mb-16 scroll-mt-20">
          ...
          <div className="space-y-6 text-slate-300 leading-relaxed">
            <p>
              Quantix uses a hybrid consensus mechanism combining{" "}
              <strong className="text-white">
                PBFT (Practical Byzantine Fault Tolerance)
              </strong>{" "}
              with <strong className="text-white">Proof-of-Stake</strong> and{" "}
              <strong className="text-white">VDF-based RANDAO</strong> for
              unpredictable, manipulation-resistant randomness.
            </p>

            <div className="space-y-4">
              <h3 className="text-lg font-semibold text-white">PBFT + PoS</h3>
              <p>
                PBFT provides immediate finality — once a block is committed, it
                cannot be reversed. The protocol requires{" "}
                <code className="text-cyan-400 bg-black/40 px-1 rounded">
                  ⌊2N/3⌋ + 1
                </code>{" "}
                votes (strictly more than two-thirds) for both prepare and
                commit phases. This ensures safety even if up to{" "}
                <code className="text-cyan-400 bg-black/40 px-1 rounded">
                  ⌊(N-1)/3⌋
                </code>{" "}
              ...
              <p>
                Leader election uses a Verifiable Delay Function (VDF) over a
                class group to produce unbiasable randomness. The VDF requires
                sequential computation (~1,048,576 squarings) that cannot be
                parallelized, preventing last-revealer grinding attacks.
              </p>
              ...
              <ul className="space-y-2 mt-2">
                <li className="flex gap-3">
                  ...
                  <span>
                    <strong className="text-white">
                      No commit/reveal phases
                    </strong>{" "}
                    — VDF input is public at slot 0
                  </span>
                </li>
                <li className="flex gap-3">
                  <span className="text-purple-400">→</span>
                  <span>
                    <strong className="text-white">
                      1022-bit discriminant
                    </strong>{" "}
                    — canonical derivation from genesis
                  </span>
                </li>
                <li className="flex gap-3">
                  <span className="text-purple-400">→</span>
                  <span>
                    <strong className="text-white">VDF proofs verified</strong>{" "}
                    — all sync messages require valid Wesolowski proof
                  </span>
                </li>
              </ul>
              ...
              <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
                {[
                  ...
                  <div
                    key={label}
                    className="bg-white/3 border border-white/8 rounded-lg p-3 text-center"
                  >
                    <div className="text-xs text-slate-500 mb-1">{label}</div>
        ...
        <section id="cryptography" className="mb-16 scroll-mt-20">
          <h2
            ...
            style={{ fontFamily: "var(--font-orbitron)" }}
          >
            <span className="w-8 h-8 rounded-lg bg-pink-500/10 border border-pink-500/20 flex items-center justify-center text-pink-400 text-sm">
              04
            </span>
            Cryptography
          </h2>
          <div className="space-y-6 text-slate-300 leading-relaxed">
            <p>
              Every cryptographic primitive in Quantix is chosen to resist
              quantum attacks. This is not a future upgrade — it is the current
              implementation.
            </p>
            ...
            {[
              {
                ...
                params: [
                  ...
                  "Based on: SHA-256 hash functions",
              ...
              },
              {
                ...
                params: [
                  "Provable security under lattice assumptions",
                  "SIVP hardness reduction",
                  "Fast: SWIFFT base + HAIFA mode",
              ...
              },
              {
                ...
                params: [
                  ...
                  "Post-quantum: hash functions only",
                ...
                <div className="p-4 space-y-3">
                  ...
                  <div className="flex flex-wrap gap-2">
                    {params.map((p) => (
                      <span
                        key={p}
                        className="px-2 py-1 rounded text-xs bg-white/5 text-slate-400 border border-white/8"
                      >
                        {p}
                      </span>
                    ))}
        ...
        <section id="tokenomics" className="mb-16 scroll-mt-20">
          ...
          <div className="space-y-6 text-slate-300 leading-relaxed">
            ...
            <p>
              Transaction fees in Quantix use a gas model similar to Ethereum
              but with post-quantum signature overhead accounted for in gas
              calculations. Gas limit and gas price are set by the transaction
              sender. Block gas limit is 10,000,000 units per block.
            </p>

            <div className="bg-black/40 rounded-xl border border-white/8 p-4 font-mono text-sm">
              <div className="text-slate-500 mb-2">{"// Fee calculation"}</div>
              <div className="text-slate-300">
                fee = gas_used × gas_price (in nQTX)
              </div>
          ...
          <div className="space-y-4 text-slate-300 leading-relaxed">
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
              {[
                ...
                <div
                  key={name}
                  className="border rounded-xl p-4 bg-white/3"
                ...
                >
                  ...
                  <div className="space-y-1 text-xs">
                    ...
                    <div className="flex justify-between">
                      ...
                      <span className="text-slate-300 font-mono">{port}</span>
                    </div>
                    <div className="flex justify-between">
                      <span className="text-slate-500">HTTP Port</span>
                      <span className="text-slate-300 font-mono">8560</span>
                    </div>
                    <div className="flex justify-between">
                      <span className="text-slate-500">WS Port</span>
                      <span className="text-slate-300 font-mono">8700</span>
                    </div>
                  </div>
                </div>
              ))}
            ...
            <p>
              Nodes communicate via TCP for block propagation and consensus
              messages, and UDP for peer discovery via DHT. All node-to-node
              communication is encrypted using the hybrid X25519 + Kyber768
              handshake. DHT authentication uses 32-byte cryptographic secrets
              generated via <code className="text-cyan-400">crypto/rand</code>.
            </p>
          </div>
        </section>
        ...
        <section id="node" className="mb-16 scroll-mt-20">
          <h2
            ...
            style={{ fontFamily: "var(--font-orbitron)" }}
          >
            <span className="w-8 h-8 rounded-lg bg-green-500/10 border border-green-500/20 flex items-center justify-center text-green-400 text-sm">
              07
            </span>
            Run a Node
          </h2>
          <div className="space-y-6 text-slate-300 leading-relaxed">
            ...
            <ul className="space-y-1 text-sm">
              <li className="flex gap-2">
                <span className="text-green-400">✓</span>Go 1.24 or higher
              </li>
              <li className="flex gap-2">
                <span className="text-green-400">✓</span>Linux or macOS (Windows
                experimental)
              </li>
              <li className="flex gap-2">
                <span className="text-green-400">✓</span>4GB RAM minimum (8GB
                recommended)
              </li>
              <li className="flex gap-2">
                <span className="text-green-400">✓</span>50GB disk space
              </li>
              <li className="flex gap-2">
                <span className="text-green-400">✓</span>Stable internet
                connection
              </li>
            </ul>
  ...
  -tcp-addr 0.0.0.0:32421`}</pre>
            ...
            <div className="space-y-2 text-sm">
              {[
                ...
                [
                  "-roles",
                  "Comma-separated roles: validator, sender, receiver, none",
                  "none",
                ],
                ...
                <div
                  key={flag}
                  className="grid grid-cols-3 gap-4 p-2 rounded bg-white/3 border border-white/5"
                >
                  <code className="text-cyan-400 text-xs font-mono">
                    {flag}
                  </code>
                  <span className="text-slate-400 text-xs col-span-2">
                    {desc}{" "}
                    {def && (
                      <span className="text-slate-600">(default: {def})</span>
                    )}
                  </span>
                </div>
              ))}
        ...
        <section id="api" className="mb-16 scroll-mt-20">
          <h2
            ...
            style={{ fontFamily: "var(--font-orbitron)" }}
          >
            <span className="w-8 h-8 rounded-lg bg-yellow-500/10 border border-yellow-500/20 flex items-center justify-center text-yellow-400 text-sm">
              08
            </span>
            API Reference
          </h2>
          <div className="space-y-4 text-slate-300">
            <p>
              The Quantix node exposes a JSON HTTP API on port{" "}
              <code className="text-cyan-400">8560</code> by default.
            </p>
              ...
              {[
                {
                  method: "GET",
                  path: "/",
                  desc: "Node status, blockchain info, available endpoints",
                },
                {
                  method: "GET",
                  path: "/blockcount",
                  desc: "Returns current block count",
                },
                {
                  method: "GET",
                  path: "/bestblockhash",
                  desc: "Returns the hash of the latest block",
                },
                {
                  method: "GET",
                  path: "/block/:id",
                  desc: "Returns full block data by height (0-indexed)",
                },
                {
                  method: "GET",
                  path: "/address/:addr",
                  desc: "Returns balance, total sent/received, tx count for an address",
                },
                {
                  method: "GET",
                  path: "/address/:addr/txs",
                  desc: "Returns all transactions for an address with direction (IN/OUT)",
                },
                {
                  method: "GET",
                  path: "/latest-transaction",
                  desc: "Returns the most recently submitted transaction",
                },
                {
                  method: "GET",
                  path: "/metrics",
                ...
                },
                {
                  method: "POST",
                  path: "/transaction",
                  desc: "Submit a new transaction",
                },
                {
                  method: "POST",
                  path: "/mine",
                  desc: "Trigger devnet block mining (requires DEVNET_MINE_SECRET header)",
                },
              ].map(({ method, path, desc }) => (
                <div
                  key={path}
                  className="flex gap-4 p-3 bg-white/3 rounded-lg border border-white/5 items-start"
                >
                  <span
                    className={`shrink-0 text-xs font-bold px-2 py-0.5 rounded font-mono ${method === "GET" ? "bg-green-500/10 text-green-400" : "bg-orange-500/10 text-orange-400"}`}
                  >
                    {method}
                  </span>
                  <code className="text-cyan-400 text-xs font-mono shrink-0 w-48">
                    {path}
                  </code>
                  <span className="text-slate-400 text-sm">{desc}</span>
                </div>
  ...
  "signature": ""                {/* SPHINCS+ signature (devnet: empty) */}
        ...
        <section id="security" className="mb-16 scroll-mt-20">
          <h2
            ...
            style={{ fontFamily: "var(--font-orbitron)" }}
          >
            <span className="w-8 h-8 rounded-lg bg-red-500/10 border border-red-500/20 flex items-center justify-center text-red-400 text-sm">
              09
            </span>
            Security
          </h2>
          <div className="space-y-4 text-slate-300 leading-relaxed">
            <p>
              Quantix underwent a comprehensive internal security audit in April
              2026 covering cryptographic correctness, consensus safety,
              transaction validation, network security, and code quality. All 27
              findings were resolved before devnet launch.
            </p>
            ...
            {[
              {
                ...
                status: "✅ COMPLETE",
                items: [
                  "Real state execution (ExecuteBlock)",
                  "Persistent account state (LevelDB)",
                  "Balance validation in mempool",
                  "CI/CD pipeline",
              ...
              },
              {
                ...
                status: "Planned",
                items: [
                  "Production DHT peer discovery",
                  "Validator join/leave protocol",
