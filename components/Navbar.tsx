      ...
      <div style={{
        ...
        <div className="desktop-nav" style={{ display: 'flex', gap: '1.5rem', alignItems: 'center' }}>
          {navLinks.map(({ label, href }) => (
            <a key={label} href={href} style={{
              color: 'rgba(224,224,255,0.7)', textDecoration: 'none',
          ...
          <a href="https://github.com/ramseyauron/quantix" target="_blank" rel="noopener noreferrer"
            style={{
              padding: '0.4rem 1rem',
              border: '1px solid #00FFFF', borderRadius: '6px',
        ...
        <button
          ...
          style={{
            ...
            padding: '0.5rem', color: '#00FFFF', display: 'none',
          }}
        >
          {menuOpen ? (
        ...
        <div className="mobile-menu" style={{
          ...
          {navLinks.map(({ label, href }) => (
            <a
              ...
              style={{
                color: 'rgba(224,224,255,0.8)', textDecoration: 'none',
                fontSize: '1rem', fontWeight: 500, padding: '0.6rem 0',
                borderBottom: '1px solid rgba(255,255,255,0.05)',
                fontFamily: 'var(--font-body)', transition: 'color 0.2s',
              }}
              onMouseEnter={e => (e.currentTarget.style.color = '#00FFFF')}
              onMouseLeave={e => (e.currentTarget.style.color = 'rgba(224,224,255,0.8)')}
            >{label}</a>
          ))}
          <a
            ...
            style={{
              ...
              fontFamily: 'var(--font-heading)', alignSelf: 'flex-start',
            }}
          >
